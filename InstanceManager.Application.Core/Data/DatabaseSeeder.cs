...
public static class DatabaseSeeder
{
    public static async Task SeedAsync(InstanceManagerDbContext context)
    {
        ...
        {
            var projects = new List<ProjectInstance.ProjectInstance>();

            // Create root projects
            var project1 = new ProjectInstance.ProjectInstance
            {
                Id = Guid.NewGuid(),
            ...
            var project2 = new ProjectInstance.ProjectInstance
            {
                Id = Guid.NewGuid(),
            ...
            var project3 = new ProjectInstance.ProjectInstance
            {
                Id = Guid.NewGuid(),
            ...
            var childProject1 = new ProjectInstance.ProjectInstance
            {
                Id = Guid.NewGuid(),
            ...
            var childProject2 = new ProjectInstance.ProjectInstance
            {
                Id = Guid.NewGuid(),
            ...
            var childProject3 = new ProjectInstance.ProjectInstance
            {
                Id = Guid.NewGuid(),
                Name = "iOS App",
            ...
            var childProject4 = new ProjectInstance.ProjectInstance
            {
                Id = Guid.NewGuid(),
                Name = "Android App",
            ...
            var nestedChildProject = new ProjectInstance.ProjectInstance
            {
                Id = Guid.NewGuid(),
            ...
            var project4 = new ProjectInstance.ProjectInstance
            {
                Id = Guid.NewGuid(),
                Name = "Internal Tools",
